...
export function GelisimProgramiBilgilendirmePage() {
  return (
    <OnboardingForm
      ...
      successText="Şu anda bilgilerini inceleyip programını hazırlıyorum. Programın hazır olduğunda sana haber vereceğim ve inşallah 12 Temmuz günü süreci başlatacağız."
    />
  );
}
